...
echo_and_run cd "/home/minchul/carla_ws/src/Mobile_System_Control/carla_ros_bridge/carla_ros_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/home/minchul/carla_ws/src/Mobile_System_Control/carla_ros_bridge/carla_ros_bridge/setup.py" \
     \
    build --build-base "/home/minchul/carla_ws/build/Mobile_System_Control/carla_ros_bridge/carla_ros_bridge" \
    install \
    --root="${DESTDIR-/}" \
